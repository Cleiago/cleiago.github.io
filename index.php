        ...
        <ul id="nav-mobile" class="light hide-on-med-and-down">
          ...
          <ul id="dropdown2" class="dropdown-content">
            ...
            if(isset($_SESSION["login"])){
              echo "<li><a href=\"cadClientes.php\" class=\"black-text text\">Cadastrar Clientes</a></li>";
              echo "<li><a href=\"verClientes.php\" class=\"black-text text\">Lista Clientes</a></li>";
            }else{
          ...
          <ul id="dropdown3" class="dropdown-content">
            <?php
            if(isset($_SESSION["login"])){
              echo "<li><a href=\"cadProdutos.php\" class=\"black-text text\">Lista Produtos</a></li>";
              echo "<li><a href=\"verProdutos.php\" class=\"black-text text\">Cadastrar Produtos</a></li>";
            }else{
              echo "<meta http-equiv=\"refresh\" content=\"0; url=authentication.php?url=index.php\">";
            }
            ?>
          ...
          <ul id="dropdown6" class="dropdown-content">
            <?php
            if(isset($_SESSION["login"])){
              echo "<li><a href=\"aluga.php\" class=\"black-text text\">Empréstimo</a></li>";
              echo "<li><a href=\"devolucao.php\" class=\"black-text text\">Devolução</a></li>";
              echo "<li><a href=\"compra.php\" class=\"black-text text\">Compra</a></li>";
            }else{
              echo "<meta http-equiv=\"refresh\" content=\"0; url=authentication.php?url=index.php\">";
            }
            ?>
        ...
        <ul id="mobile-sidenav" class="side-nav">
         <span class="controller controller-nav" id="btRB"></span>
          ...
          <ul id="dropdown7" class="dropdown-content">
            <?php
            if(isset($_SESSION["login"])){
              echo "<li><a href=\"aluga.php\" class=\"black-text text\">Lista Produtos</a></li>";
              echo "<li><a href=\"devolucao.php\" class=\"black-text text\">Cadastrar Produtos</a></li>";
              echo "<li><a href=\"compra.php\" class=\"black-text text\">Cadastrar Produtos</a></li>";
            }else{
              echo "<meta http-equiv=\"refresh\" content=\"0; url=authentication.php?url=index.php\">";
            }
            ?>
